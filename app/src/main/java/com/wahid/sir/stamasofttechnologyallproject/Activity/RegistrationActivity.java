    ...
    private void confirmOtp() throws JSONException {
        ...
        buttonConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final ProgressDialog loading = ProgressDialog.show(RegistrationActivity.this, "Authenticating", "Please wait while we check the entered code", false,false);
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                if(response.equalsIgnoreCase("success")){
                                    ...
                                    startActivity(new Intent(RegistrationActivity.this, Success.class));
                                }else{
                                    //Displaying a toast if the otp entered is wrong
                                    Toast.makeText(RegistrationActivity.this,"Wrong OTP Please Try Again",Toast.LENGTH_LONG).show();
                                    try {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(jsonResponse.getString(Config.TAG_RESPONSE).equalsIgnoreCase("Success")){
                                ...
                                Toast.makeText(RegistrationActivity.this, "Username or Phone number already registered", Toast.LENGTH_LONG).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
